export const experience = [
  ...
  },
  {
    ...
    period: "2023 - Present",
    highlights: [
      "Founded and manage a tech-focused company delivering solar, surveillance (CCTV), and digital solutions.",
      "Oversee system design, installation, and technical operations for clients.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Prepared students for academic success through personalized instruction and support.",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Conducted sentiment and political opinion analysis on Twitter data during the 2023 Nigerian elections.",
    ],
  },
  {
    ...
    highlights: [
      ...
      "Focused on performance, accessibility, and modern UI/UX best practices.",
    ],
  },
 
  {
    ...
    highlights: [
      ...
      "Supported structured learning and performance tracking.",
    ],
  },
  {
    title: "NYSC Corps Member",
    organization: "National Youth Service Corps (Abuja)",
    period: "2025 - Present",
    highlights: [
      "Currently serving as an NYSC Corps Member in Abuja.",
      "Applying data analysis, research, and digital skills to professional tasks.",
      "Actively engaged in national service and professional development.",
    ],
  },
];
